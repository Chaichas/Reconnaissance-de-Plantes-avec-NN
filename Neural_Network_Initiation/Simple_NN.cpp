...
double init_weight() { return ((double)rand())/((double)RAND_MAX); } // Init all weights and biases between 0.0 and 1.0
...
/*Defining the dimensions of the network and allocate the arrays for the layers, 
biases and weights*/
